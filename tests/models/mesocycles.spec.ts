...
test('create a mesocycle', async ({ page }) => {
	...
	await expect(page.getByRole('tabpanel')).toContainText(
		'RIR progression 12 cycles 2 1 0 Exercise split Pull Push Legs Preferred progression variable Load Start overload percentage 1.25% Last set to failure Force RIR matching'
	);
