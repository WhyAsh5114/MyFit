...
<div class="prose prose-neutral max-w-none dark:prose-invert lg:prose-lg">
	...
	<ul>
		...
		<li>
			<p>
				...
				from the Service infrastructure itself (for example, the duration of a page visit, interactions with the
				interface, and navigation patterns recorded during a session).
			</p>
		</li>
		<li>
			<p>
	...
	<p>
		As a fitness application, We collect health and fitness data that You voluntarily provide, including but not
		limited to:
	</p>
	<ul>
	...
	<p>
		This health and fitness data is stored securely and used solely to provide the Service's core functionality and
		to personalize Your experience. We do not sell or share this data with third parties for marketing purposes.
	</p>
	...
	<p>
		PostHog is configured to mask all input fields and sensitive content within session recordings. No passwords,
		health data entries, or other sensitive form inputs are captured in recordings.
	</p>
	<p>
