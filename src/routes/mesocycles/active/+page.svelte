<script lang="ts">
	...
	import BestExercises from '$lib/components/mesocycleSummary/BestExercises.svelte';
	import ExerciseChart from '$lib/components/mesocycleSummary/ExerciseChart.svelte';
	import VolumeChart from '$lib/components/mesocycleSummary/VolumeChart.svelte';
