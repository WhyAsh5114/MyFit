...
<div class="stats stats-vertical">
	<div class="stat">
		...
		<a
			...
			href="/mesocycles/viewTemplate/{data.activeMesocycleTemplate.id}"
		>
							...
							<a class="btn h-8 btn-sm" href="/workouts/{workout.id}/view">
								<div class="flex w-full justify-between items-center">
									...
									<span class="font-normal text-sm">
										{data.activeMesocycleTemplate.exerciseSplit[workout.dayNumber]?.name}, Cycle {workout.cycleNumber}
									</span>
								</div>
							</a>
						{/if}
