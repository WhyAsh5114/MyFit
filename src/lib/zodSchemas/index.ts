...
export const WorkoutExerciseSetScalarFieldEnumSchema = z.enum(['id','workoutExerciseId','rep','load','RIR']);

export const WorkoutExerciseMiniSetsScalarFieldEnumSchema = z.enum(['id','rep','load','RIR','workoutExerciseSetId']);
