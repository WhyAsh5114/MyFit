...
<div class="flex flex-col bg-primary w-full h-fit rounded-md p-2 gap-1.5">
	...
	{#if exercise.note}
		<p class="bg-info bg-opacity-75 text-black px-1 text-sm rounded-sm">{exercise.note}</p>
	{/if}
</div>
