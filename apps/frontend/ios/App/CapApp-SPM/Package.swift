...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapgoCapacitorHealth", path: "../../../../../node_modules/.pnpm/@capgo+capacitor-health@8.6.2_@capacitor+core@8.4.0/node_modules/@capgo/capacitor-health"),
        .package(name: "CapgoCapacitorUpdater", path: "../../../../../node_modules/.pnpm/@capgo+capacitor-updater@8.49.0_@capacitor+core@8.4.0/node_modules/@capgo/capacitor-updater")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
