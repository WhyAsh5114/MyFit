...
export function whereStringFilter<T, R extends Prisma.Result<T, object, "findFirstOrThrow">>(record: R, fieldName: keyof R, stringFilter: undefined | string | Prisma.StringFilter<unknown> | null | Prisma.StringNullableFilter<unknown>): boolean {
...
export function whereNumberFilter<T, R extends Prisma.Result<T, object, "findFirstOrThrow">>(record: R, fieldName: keyof R, numberFilter: undefined | number| Prisma.IntFilter<unknown>): boolean {
...
export function whereBoolFilter<T, R extends Prisma.Result<T, object, "findFirstOrThrow">>(record: R, fieldName: keyof R, boolFilter: undefined | boolean | Prisma.BoolFilter<unknown> | null | Prisma.BoolNullableFilter<unknown>): boolean {
...
export function whereDateTimeFilter<T, R extends Prisma.Result<T, object, "findFirstOrThrow">>(record: R, fieldName: keyof R, dateTimeFilter: undefined | Date | string | Prisma.DateTimeFilter<unknown> | null | Prisma.DateTimeNullableFilter<unknown>): boolean {
...
export function handleStringUpdateField<T, R extends Prisma.Result<T, object, "findFirstOrThrow">>(record: R, fieldName: keyof R, stringUpdate: undefined | string | Prisma.StringFieldUpdateOperationsInput | null | Prisma.NullableStringFieldUpdateOperationsInput) {
...
export function handleBooleanUpdateField<T, R extends Prisma.Result<T, object, "findFirstOrThrow">>(record: R, fieldName: keyof R, booleanUpdate: undefined | boolean | Prisma.BoolFieldUpdateOperationsInput | null | Prisma.NullableBoolFieldUpdateOperationsInput) {
...
export function handleDateTimeUpdateField<T, R extends Prisma.Result<T, object, "findFirstOrThrow">>(record: R, fieldName: keyof R, dateTimeUpdate: undefined | Date | string | Prisma.DateTimeFieldUpdateOperationsInput | null | Prisma.NullableDateTimeFieldUpdateOperationsInput) {
    ...
    )
    {
        ...
        dateTimeUpdate === null ? null : new Date(dateTimeUpdate);
    }
...
export function handleIntUpdateField<T, R extends Prisma.Result<T, object, "findFirstOrThrow">>(record: R, fieldName: keyof R, intUpdate: undefined | number | Prisma.IntFieldUpdateOperationsInput) {
...
export function handleScalarListUpdateField<T, R extends Prisma.Result<T, object, "findFirstOrThrow">>(record: R, fieldName: keyof R, listUpdate: undefined | unknown[] | { set?: unknown[]; push?: unknown | unknown[] }) {
